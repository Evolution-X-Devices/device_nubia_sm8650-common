...
PRODUCT_COPY_FILES += \
    ...
    $(COMMON_PATH)/audio/audio_effects.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio/sku_pineapple/audio_effects.xml \
...
PRODUCT_PACKAGES += \
    ...
    NubiaWallpaperPicker2Overlay \
    NubiaWallpaperPicker2PixelOverlay \
    WifiResCommon_Sys \
    WifiResOverlay \
    WifiResTarget \
    WifiResTarget_spf
